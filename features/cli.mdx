---
title: "CLI"
description: "Easily migrate your Shopify products to the search platform  with our CLI"
icon: "terminal"
---
...
Our CLI will try to find required environment variables in `[starter]/.env.local`.
...
And depending on the search platform:
