...
> **Note:** By default, your commerce application runs in **demo mode**. To access all features, ensure the following variables are set in your `.env.local` file and `NEXT_PUBLIC_IS_DEMO_MODE=false`.
